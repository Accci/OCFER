...
parser.add_argument('--data_path', default='../data/affectnet', type=str)
parser.add_argument('--results', default='./results/affect', type=str)
parser.add_argument('--save_freq', default=5, type=int)
parser.add_argument('--resume', default=0, type=int)
parser.add_argument('--seed', default=0, type=int)
parser.add_argument('--name', default='affect1', type=str)
